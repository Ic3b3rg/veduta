...
- Self-improvement: if the Heartbeat finds something that _could_ have been a timer, the preferred action is to arm the timer (so the next sweep isn't needed)
