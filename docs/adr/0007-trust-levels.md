...
> [ADR-0026](0026-skills-may-drive-general-tool-execution.md) preserves these trust levels as
> official product policy and typed-tool enforcement, but supersedes the claim that they form a
> universal semantic sandbox for the general execution tool.
...
- These controls remain structurally enforced for typed product tools. The general execution path
  introduced by ADR-0026 is deliberately broader: official Skills follow and test the same policy,
  but Veduta does not claim that arbitrary command semantics form an unbypassable capability
  boundary.
